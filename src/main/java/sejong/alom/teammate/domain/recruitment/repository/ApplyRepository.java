...
public interface ApplyRepository extends JpaRepository<Apply, Long> {
	...
	@Query(value = "select a from Apply a " +
		...
		countQuery = "select count(a) from Apply a where a.member.id = :memberId")
	Page<Apply> findAllByMemberIdWithRecruitmentAndTeam(@Param("memberId") Long memberId, Pageable pageable);
}
